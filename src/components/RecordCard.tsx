...
import { CheckCircle, AlertCircle, Clock, MapPin, Fuel, Gauge, DollarSign } from 'lucide-react';
...
export const RecordCard: React.FC<RecordCardProps> = ({ record, onClick }) => {
  ...
  return (
    <div 
      onClick={onClick}
      className={cn(
        "group relative overflow-hidden rounded-2xl border p-5 transition-all hover:shadow-md cursor-pointer",
        bg, border
      )}
    >
